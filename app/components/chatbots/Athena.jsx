...
class Athena extends Component {
    ...
    scaleChat() {
        ...
        const scaleClass = isMobile ? 'mobileScale' : 'scale';
    ...
    componentDidMount() {
        domEvents.forEach(e => window.addEventListener(e, this.scaleChat));
    }

    componentWillUnmount() {
        domEvents.forEach(e => window.removeEventListener(e, this.scaleChat));
    }
